static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_RUSTBORO_CITY - 1] = {MAP_GROUP(MUSEMOTOR_CITY), MAP_NUM(MUSEMOTOR_CITY), 32, 21},
    [HEAL_LOCATION_FORTREE_CITY - 1] = {MAP_GROUP(FORTREE_CITY), MAP_NUM(FORTREE_CITY), 5, 7},
    [HEAL_LOCATION_LILYCOVE_CITY - 1] = {MAP_GROUP(KUSAKATTA_CITY), MAP_NUM(KUSAKATTA_CITY), 24, 15},
    [HEAL_LOCATION_MOSSDEEP_CITY - 1] = {MAP_GROUP(OHIYO_CITY), MAP_NUM(OHIYO_CITY), 28, 17},
    ...
    [HEAL_LOCATION_DEWFORD_TOWN - 1] = {MAP_GROUP(SANDPORT_TOWN), MAP_NUM(SANDPORT_TOWN), 2, 11},
