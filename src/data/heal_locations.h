static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_MUSEMOTOR_CITY - 1] = {MAP_GROUP(MUSEMOTOR_CITY), MAP_NUM(MUSEMOTOR_CITY), 32, 21},
    [HEAL_LOCATION_FORTREE_CITY - 1] = {MAP_GROUP(FORTREE_CITY), MAP_NUM(FORTREE_CITY), 5, 7},
    [HEAL_LOCATION_KUSAKATTA_CITY - 1] = {MAP_GROUP(KUSAKATTA_CITY), MAP_NUM(KUSAKATTA_CITY), 24, 15},
    [HEAL_LOCATION_OHIYO_CITY - 1] = {MAP_GROUP(OHIYO_CITY), MAP_NUM(OHIYO_CITY), 45, 21},
    ...
    [HEAL_LOCATION_SANDPORT_TOWN - 1] = {MAP_GROUP(SANDPORT_TOWN), MAP_NUM(SANDPORT_TOWN), 2, 11},
