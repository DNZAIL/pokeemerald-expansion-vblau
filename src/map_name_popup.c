...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_SANDPORT_TOWN] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_MUSEMOTOR_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_FORTREE_CITY] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_KUSAKATTA_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_OHIYO_CITY] = MAPPOPUP_THEME_BRICK,
