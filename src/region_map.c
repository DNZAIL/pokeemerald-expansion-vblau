...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_DEWFORD_TOWN] = {MAP_GROUP(SANDPORT_TOWN), MAP_NUM(SANDPORT_TOWN), HEAL_LOCATION_DEWFORD_TOWN},
    ...
    [MAPSEC_RUSTBORO_CITY] = {MAP_GROUP(MUSEMOTOR_CITY), MAP_NUM(MUSEMOTOR_CITY), HEAL_LOCATION_RUSTBORO_CITY},
    [MAPSEC_FORTREE_CITY] = {MAP_GROUP(FORTREE_CITY), MAP_NUM(FORTREE_CITY), HEAL_LOCATION_FORTREE_CITY},
    [MAPSEC_LILYCOVE_CITY] = {MAP_GROUP(KUSAKATTA_CITY), MAP_NUM(KUSAKATTA_CITY), HEAL_LOCATION_LILYCOVE_CITY},
    [MAPSEC_MOSSDEEP_CITY] = {MAP_GROUP(OHIYO_CITY), MAP_NUM(OHIYO_CITY), HEAL_LOCATION_MOSSDEEP_CITY},
