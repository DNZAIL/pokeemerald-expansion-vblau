...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_AQUA_HIDEOUT,               MAPSEC_KUSAKATTA_CITY},
    {MAPSEC_AQUA_HIDEOUT_OLD,           MAPSEC_KUSAKATTA_CITY},
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_SANDPORT_TOWN] = {MAP_GROUP(SANDPORT_TOWN), MAP_NUM(SANDPORT_TOWN), HEAL_LOCATION_SANDPORT_TOWN},
    ...
    [MAPSEC_MUSEMOTOR_CITY] = {MAP_GROUP(MUSEMOTOR_CITY), MAP_NUM(MUSEMOTOR_CITY), HEAL_LOCATION_MUSEMOTOR_CITY},
    [MAPSEC_FORTREE_CITY] = {MAP_GROUP(FORTREE_CITY), MAP_NUM(FORTREE_CITY), HEAL_LOCATION_FORTREE_CITY},
    [MAPSEC_KUSAKATTA_CITY] = {MAP_GROUP(KUSAKATTA_CITY), MAP_NUM(KUSAKATTA_CITY), HEAL_LOCATION_KUSAKATTA_CITY},
    [MAPSEC_OHIYO_CITY] = {MAP_GROUP(OHIYO_CITY), MAP_NUM(OHIYO_CITY), HEAL_LOCATION_OHIYO_CITY},
...
static void RegionMap_InitializeStateBasedOnSSTidalLocation(void)
{
    ...
    case SS_TIDAL_LOCATION_LILYCOVE:
        sRegionMap->mapSecId = MAPSEC_KUSAKATTA_CITY;
        break;
